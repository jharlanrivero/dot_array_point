function it2 = integral_t2(N, km, H, q, fn, Rm, rm)
%
...
%             i12(k)=0; error_i12(k)= 0;
           ...
           fun1 = @(x)(itotal2(N, km, H, q, fn, Rm, rm(k), x));
           it2(k) = integral(fun1,0,1)

      end    
end
  
function I = itotal2(N, km, H, q, fn, Rm, rm, s)
 
         [I, ~] = integral_t(N, km, H, q, fn, Rm, rm, s);   

function i1G2 = integral_oneG2(N, km, H, Rm, rm)
%
...
%             i12(k)=0; error_i12(k)= 0;
           ...
           fun1 = @(x)(ioneG2(N, km, H, Rm, rm(k), x));
           i1G2(k) = integral(fun1,0,1)

      end    
end
  
function I = ioneG2(N, km, H, Rm, rm, s)
 
         [I, ~] = integral_oneG(N, km, H, Rm, rm, s);   
